...
with col1:
    tangible_threshold = st.number_input("Tangible threshold (Latest 52 Wks > ?)", min_value=0.0, value=2.0)
with col2:
    growing_threshold = st.number_input("Growing penetration threshold (Latest 26 vs YA > ?)", min_value=0.0, value=0.2)
